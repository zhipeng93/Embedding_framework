...
abstract class NodeRec extends JudgeBase{
    ...
    void validate() throws NumberFormatException, IOException {
    ...
    public ArrayList<NodeScore> singleTopk(HashSet<Integer> train_graph[], int node){
        /**
        ...
        for (int j = 0; j < node_num; j++) {
            ...
            single_topk.add(new NodeScore(j, calculateScore(node, j)));
        }
    ...
    public HashMap<Integer, Set<Integer>> generateTopk() throws IOException {
        ...
        for (int i: query_nodes) {
             ...
             */
            List<NodeScore> score = singleTopk(train_graph, i);
            /**
